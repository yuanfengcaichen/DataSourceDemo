...
import com.xuelangyun.datasource.tx.TransationalManager;
...
public class ProxyFactory {
  ...
  @Autowired TransationalManager transationalManager;
    ...
    return Proxy.newProxyInstance(
        ...
        new InvocationHandler() {
          ...
          public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
            ...
            transationalManager.begin();
            try {
              result = method.invoke(target, args);
              transationalManager.submit(true);
              log.info("事务提交");
            } catch (Exception e) {
              log.error("事务回滚，异常问题：", e);
              transationalManager.submit(false);
            }
            return result;
          }
        });
